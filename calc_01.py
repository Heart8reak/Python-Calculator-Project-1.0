...
class Calculator:
    def __init__(self, master):
        self.master = master
        master.title("Carlos's Awesome Calculator 1.0")

        # ----------Create Screen Widget----------
        self.screen = Text(master, state='disabled', width=40, height=10, background='yellow', foreground='blue')


        # ----------Position Screen in Window----------
        self.screen.grid(row=0, column=0, columnspan=8, padx=5, pady=5)
